...
public class RedPacketsManageApi extends BaseFinancialApi{
	...
	protected BaseResEntity action(HttpServletRequest request, HttpServletResponse response, String token)
		...
		RedPacketsManageReqEntity req = JSON.parseObject(json,RedPacketsManageReqEntity.class);
		if (req == null || StringUtils.emptyString(req.red_id)) {
			return null;
		}
		req.financial_token=token;
		return RedPacketDao.updateRedPacketStatus(req);
	}

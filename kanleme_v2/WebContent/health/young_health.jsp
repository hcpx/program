    ...
    <ul class="yhn3_list">
    	<li class="yhn3_listli">
        	<div class="yhn3_listlid1 clearfix">
                ...
                <div class="yhn3_listlid1d fr clearfix"><span class="fl">18-50周岁,身体健康</span><img class="fl" src="images/ic_open.png" /></div>
            </div>
        ...
        <li class="yhn3_listli">
            ...
            <div class="yhn3_listlid2">
            	<img src="images/frame_id.png" />
            	<p>不同年龄段会员可获得的最高互助金额不同，具体如下：</p>
            	<div class="table-c">
	            	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                        <td width="40%">年龄 (周岁)</td>
	                        <td width="60%">重度癌症</td>
	                    </tr>
	                    <tr>
	                        <td>18-30</td>
        ...
        <li class="yhn3_listli">
        	<div class="yhn3_listlid1 clearfix">
                ...
                <div class="yhn3_listlid1d fr"><span class="fl">恶性肿瘤等六十种疾病</span><img class="fl" src="images/ic_open.png" /></div>
            </div>
            <div class="yhn3_listlid2">
            	<img src="images/frame_id.png" />
                <p>所有恶性肿瘤（癌症），但下列疾病不可互助：</p>
                <p>(1) 原位癌及癌前病变；</p>
...
<div class="yhn6">
    ...
    <div class="clearfix">
    	<a class="fl" href="sixty_sickness.html">60种重大疾病说明</a>
...
<div class="yhn3" style="margin-bottom:0;">
    ...
    <ul class="yhn3_list">
    	<li class="yhn3_listli">
        	<div class="yhn3_listlid1 clearfix">
            	<span class="yhn3_listlid1s fl">Q1 国立看了么健康互助是真实的吗？</span>
                <div class="yhn3_listlid1d fr"><img src="images/ic_open.png" /></div>
            </div>
            <div class="yhn3_listlid2">
            	<img src="images/frame_id.png" />
            	<p>国立看了么是和成都市慈善总会合作的互助计划，是由四川国立创投科技股份有限公司发起成立。为了保障资金安全，用户所缴纳的资金由成都市慈善总会进行监督使用。为了保证互助事件的真实性和公平性，会员发生互助事件后，所提交的材料由专业第三方公司进行审核和查勘，通过后将在平台进行公示，接受全体会员的监督。同时律师事务所和公证处也对我们进行法律与公正监督。
所以请放心，国立看了么健康互助计划是真实且合法的。</p>
            </div>
        </li>
        <li class="yhn3_listli">
        	<div class="yhn3_listlid1 clearfix">
            	<span class="yhn3_listlid1s fl">Q2 已有医保、商业保险，还能加入吗</span>
                <div class="yhn3_listlid1d fr"><img src="images/ic_open.png" /></div>
            </div>
            <div class="yhn3_listlid2">
            	<img src="images/frame_id.png" />
        ...
        <li class="yhn3_listli">
            ...
            <div class="yhn3_listlid2">
                ...
                <p>（5）国立看了么是采用网络互助方式实现会员之间的相互保障，并非传统的商业保险，所以不需要保单。但加入后会有加入的电子凭证。请下载国立看了么app，点击我的‘我的健康互助’页面中可以详细看到您的姓名，身份证号，加入时间，生效时间，账户余额等；</p>
            </div>
        </li>
        <li class="yhn3_listli">
        	<div class="yhn3_listlid1 clearfix">
        ...
        <li class="yhn3_listli">
        	<div class="yhn3_listlid1 clearfix none_border">
            	<span class="yhn3_listlid1s fl">Q5 能否为他人加入？</span>
                <div class="yhn3_listlid1d fr"><img src="images/ic_open.png" /></div>
            </div>
            <div class="yhn3_listlid2">
            	<img src="images/frame_id.png" />
            	<p>您可以在您的账号下为亲友加入互助计划，没有人数限制。但是您后期要对您账号下的所有计划进行管理和充值</p>
            </div>
        </li>
    </ul>
    <div class="yhn7_div"><a href="member_action_term.html">《会员公约》</a><a href="young_health_term.html">《中青年健康互助计划条款》</a></div>
</div>
</div>
			...
			success : function(data) {
				if (data != null && data.status == "ok") {
		            ...
		            $("#health_event_num").html(data.health_event_num).append($children);
		           	if(data.health_event_num!=0)
		            	$('#event').attr('href','young_health_event.jsp?health_project_id=1'); 
				}
			},
			error : function() {
			}
